"""
Customer booking endpoints — public services, create/list/reschedule/cancel bookings.
"""
...
def browse_services(
    tenant_id: UUID = Query(..., description="Tenant ID to browse services for"),
    skip: int = Query(0, ge=0),
    limit: int = Query(50, ge=1, le=100),
    db: Session = Depends(get_db),
):
    """Public endpoint — no auth required. Customer browses tenant services."""
